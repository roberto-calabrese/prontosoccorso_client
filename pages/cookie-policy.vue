    ...
    <v-row justify="center">
      <v-col cols="12" md="8">
        <v-card class="pa-4">
          ...
          <v-card-text>
            <p>
              Questa Cookie Policy spiega cosa sono i cookie, come li utilizziamo sul nostro sito web e come gli utenti possono gestirli. Utilizziamo i cookie per migliorare l'esperienza di navigazione e per scopi analitici. In conformità con la normativa europea (GDPR e Direttiva ePrivacy), i cookie non essenziali vengono utilizzati solo con il consenso esplicito dell'utente.
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Cookie di Analisi e Prestazioni (con consenso)</strong>: per raccogliere dati anonimi sull'uso del sito e migliorare l'esperienza utente. Questi cookie vengono utilizzati solo con il consenso dell'utente.
              </li>
              <li>
                <strong>Cookie di Terze Parti</strong>: Utilizziamo cookie di terze parti per funzionalità aggiuntive, come video incorporati (<strong>YouTube</strong>) o pulsanti di condivisione sui social media (<strong>Facebook</strong>, <strong>Twitter</strong>).
              </li>
            </ul>
            ...
            <p>
              <strong>Email</strong>: admin@prontosocorso.live
            </p>
          </v-card-text>
        </v-card>
      </v-col>
